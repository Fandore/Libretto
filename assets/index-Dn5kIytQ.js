(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{name:`Spesa`,icon:`🛒`,color:`#d6a23c`},{name:`Trasporti`,icon:`🚌`,color:`#7ea487`},{name:`Casa`,icon:`🏠`,color:`#e2725b`},{name:`Bollette`,icon:`💡`,color:`#a78bd1`},{name:`Svago`,icon:`🎬`,color:`#5fb3c9`},{name:`Ristoranti`,icon:`🍝`,color:`#e0975c`},{name:`Salute`,icon:`⚕️`,color:`#7ec99a`},{name:`Abbonamenti`,icon:`📺`,color:`#d17ea8`},{name:`Stipendio`,icon:`💼`,color:`#7ea487`},{name:`Risparmi`,icon:`🏦`,color:`#d6a23c`},{name:`Altro`,icon:`✦`,color:`#bcb5a3`}],t=[`#d6a23c`,`#7ea487`,`#5fb3c9`,`#e2725b`,`#a78bd1`],n=`🛒.🚌.🏠.💡.🎬.🍝.⚕️.📺.💼.✦.🎓.🐾.👕.✈️.🎁.🔧.📱.☕.💪.🧾.🎮.🏋️.🧴.🐶.🌿.🎵.🍕.🚗.🏖️.📚`.split(`.`),r=[`#d6a23c`,`#7ea487`,`#e2725b`,`#a78bd1`,`#5fb3c9`,`#e0975c`,`#7ec99a`,`#d17ea8`,`#bcb5a3`,`#8aa6d6`,`#c97070`,`#70c9b0`,`#e8c847`,`#9e7ac4`];function i(){return`t`+Math.random().toString(36).slice(2,10)}function a(){return new Date().toISOString().slice(0,10)}function o(e,t){let n=new Date(e);return n.setDate(n.getDate()+t),n.toISOString().slice(0,10)}function s(e){return(e<0?`-`:``)+`€`+Math.abs(e).toLocaleString(`it-IT`,{minimumFractionDigits:2,maximumFractionDigits:2})}function c(e){return new Date(e).toLocaleDateString(`it-IT`,{day:`2-digit`,month:`short`})}function l(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function u(e,t){return new Date(e,t+1,0).getDate()}function d(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate())}function f(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function p(e){let[t,n,r]=String(e).slice(0,10).split(`-`).map(Number);return new Date(t,(n||1)-1,r||1)}function m(){return new Date().toISOString()}function h(e){return e?new Date(e).toLocaleString(`it-IT`,{day:`2-digit`,month:`2-digit`,hour:`2-digit`,minute:`2-digit`}):`mai`}function g(e){return e.movementType===`transfer`}function _(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}`}function v(e,t){let n=new Date(e);return n.setMonth(n.getMonth()+t),n}var y={accounts:[{id:`a1`,name:`Conto corrente`,balance:23.73,initialBalance:23.73},{id:`a2`,name:`Conto Arancio`,balance:3800.68,initialBalance:3800.68},{id:`a3`,name:`Moneyfarm`,balance:14300,initialBalance:14300}],categories:JSON.parse(JSON.stringify(e)),budgets:{Spesa:350,Trasporti:80,Casa:900,Bollette:150,Svago:100,Ristoranti:120,Abbonamenti:40},goals:[{id:`g1`,name:`Risparmi liquidi`,account:`a2`,target:5e3},{id:`g2`,name:`Investimento Moneyfarm`,account:`a3`,target:2e4}],transactions:[],alertsDismissed:{},settings:{salaryDay:27},stoppedRecurrings:[]};function ee(e){return y.categories.find(t=>t.name===e)||{name:e,icon:`✦`,color:`#bcb5a3`}}function b(e){return ee(e).icon}function x(e){return ee(e).color}function S(){return y.categories.map(e=>e.name)}function te(e){return String(e||``).toLowerCase()===`risparmi`}function C(e,t){return(e||``).toLowerCase()+`|`+(t||``)}function w(e,t){return(y.stoppedRecurrings||[]).includes(C(e,t))}function ne(e,t){y.stoppedRecurrings||=[];let n=C(e,t),r=y.stoppedRecurrings.indexOf(n);r>=0?y.stoppedRecurrings.splice(r,1):y.stoppedRecurrings.push(n),Se(),N(),J(),Y(r>=0?`Ricorrente riattivata ▶`:`Ricorrente fermata — non apparirà nelle proiezioni ⏹`)}function re(){return(y.stoppedRecurrings||[]).map(e=>{let t=e.indexOf(`|`),n=e.slice(0,t),r=e.slice(t+1),i=y.transactions.filter(e=>(e.payee||``).toLowerCase()===n&&(e.category||``)===r).sort((e,t)=>t.date.localeCompare(e.date))[0];return i?{payee:i.payee,category:i.category,amount:i.amount,freq:i.recurringFreq||`Mensile`}:null}).filter(Boolean)}function ie(e){let t=String(e.category||``).toLowerCase(),n=String(e.payee||``).toLowerCase();return e.type===`in`&&!g(e)&&(t.includes(`stipendio`)||n.includes(`stipendio`))}function T(){let e=new Set;return y.transactions.filter(ie).map(e=>d(p(e.date))).sort((e,t)=>e-t).filter(t=>{let n=f(t);return e.has(n)?!1:(e.add(n),!0)})}function E(e,t){return new Date(e,t,1)}function D(e){let t=e.getFullYear(),n=e.getMonth()+1,r=e.getDate();return new Date(t,n,Math.min(r,u(t,n)))}function ae(e){return T().find(t=>t>e)||D(e)}function oe(e=new Date){let t=d(e),n=T(),r=null;for(let e of n)if(e<=t)r=e;else break;return!r&&n.length&&(r=n[n.length-1]),r}function se(e,t){return T().find(n=>n.getFullYear()===e&&n.getMonth()===t)||E(e,t)}function ce(e,t){let n=se(e,t),r=ae(n);return{start:n,end:new Date(r.getTime()-1)}}function le(){let e=oe();if(!e){let e=E(W,U);return{start:e,end:new Date(new Date(e.getFullYear(),e.getMonth()+1,1).getTime()-1),estimated:!1,hasSalary:!1}}let t=T().find(t=>t>e)||null,n=t||ae(e);return{start:e,end:new Date(n.getTime()-1),estimated:!t,hasSalary:!0}}function O(e){let t=e=>e.toLocaleDateString(`it-IT`,{day:`2-digit`,month:`short`});return`${t(e.start)} – ${t(e.end)} ${e.end.getFullYear()}`}function ue(e,t){return O(ce(e,t))}function de(e){return y.transactions.filter(t=>{let n=d(p(t.date));return n>=e.start&&n<=e.end})}function fe(e){let t=d(p(e)),n=T(),r=null;for(let e of n)if(e<=t)r=e;else break;return r||=E(t.getFullYear(),t.getMonth()),_(r)}function pe(e=!0){let t=new Set(T().map(_));if(e){let e=new Date(W,U,1);for(let n=-6;n<=6;n++)t.add(_(v(e,n)))}return[...t].sort()}function k(){let e=le();return{year:e.start.getFullYear(),month:e.start.getMonth(),bounds:e}}function me(){let e=a(),t=[];function n(n,r,a,s,c,l){t.push({id:i(),date:o(e,-n),account:r,category:a,payee:s,amount:c,type:l})}return[2,32,62].forEach(e=>n(e,`a1`,`Casa`,`Affitto`,650,`out`)),[5,35,65].forEach(e=>n(e,`a1`,`Abbonamenti`,`Netflix`,12.99,`out`)),[7,37].forEach(e=>n(e,`a1`,`Abbonamenti`,`Palestra FitClub`,39.9,`out`)),[1,31].forEach(e=>n(e,`a2`,`Stipendio`,`Stipendio`,1850,`in`)),n(1,`a1`,`Spesa`,`Esselunga`,54.3,`out`),n(3,`a1`,`Trasporti`,`Trenord`,18.5,`out`),n(4,`a1`,`Ristoranti`,`Trattoria Da Marco`,32,`out`),n(6,`a1`,`Spesa`,`Carrefour`,41.1,`out`),n(8,`a1`,`Svago`,`Cinema UCI`,12,`out`),n(9,`a1`,`Salute`,`Farmacia Centrale`,22.4,`out`),n(11,`a1`,`Spesa`,`Esselunga`,37.85,`out`),n(13,`a1`,`Trasporti`,`ATM Milano`,22,`out`),n(15,`a1`,`Ristoranti`,`Sushi Time`,28.5,`out`),n(18,`a1`,`Bollette`,`Enel Energia`,78.2,`out`),n(20,`a1`,`Spesa`,`Lidl`,29.95,`out`),n(22,`a1`,`Svago`,`Spotify`,9.99,`out`),n(25,`a1`,`Casa`,`IKEA`,64,`out`),n(0,`a1`,`Spesa`,`Esselunga`,19.4,`out`),t.sort((e,t)=>e.date<t.date?1:-1),t}var A=`22.3-feedback-form`,he=`https://marvmbewsgxrabirugkk.supabase.co`,ge=`sb_publishable_Jsd4sX6_6pNCUqHIcun4lA_9F81WlPg`,j=`libretto-v2-standalone-state`,_e=`libretto-cloud-config`,ve=`libretto-device-id`,M={client:null,user:null,ready:!1,loading:!1,syncing:!1,status:`local`,lastSync:null,lastError:null,pending:!1},ye=null;function be(){let e=localStorage.getItem(ve);return e||(e=`dev-`+Math.random().toString(36).slice(2)+`-`+Date.now().toString(36),localStorage.setItem(ve,e)),e}function xe(){return y._meta||={},y._meta.createdAt||(y._meta.createdAt=m()),y._meta.deviceId||(y._meta.deviceId=be()),y._meta.appVersion||(y._meta.appVersion=A),y._meta}function Se(){let e=xe();e.updatedAt=m(),e.deviceId=be(),e.appVersion=A}function Ce(){return y._meta&&y._meta.updatedAt||``}function we(){return{url:he,anonKey:ge}}function Te(){let e=we();return!!(e.url&&e.anonKey)}function Ee(){return Te()?M.syncing?`Sincronizzazione in corso…`:M.lastError?`Errore cloud: controlla connessione o configurazione`:M.user?`Cloud attivo · ${M.user.email||M.user.id}`:`Cloud configurato, login non effettuato`:`Cloud non disponibile`}function De(){return M.syncing?`sync`:M.user&&!M.lastError?`on`:`off`}function Oe(){return((M.user&&M.user.email||``).trim()[0]||`U`).toUpperCase()}function ke(){return Te()&&!M.user}function Ae(){let e=document.getElementById(`userPillRoot`);if(e)if(M.user){e.innerHTML=`<div class="user-pill" title="Utente collegato">
      <div class="user-pill-main"><div class="avatar">${l(Oe())}</div><div class="uinfo"><div style="font-weight:700;line-height:1">Utente attivo</div><div class="uemail">${l(M.user.email||M.user.id)}</div></div></div>
    ...
    </div>`;let t=document.getElementById(`pillCloudBtn`);t&&t.addEventListener(`click`,()=>gt(`cloud`));let n=document.getElementById(`pillLogoutBtn`);n&&n.addEventListener(`click`,async()=>{M.client&&await M.client.auth.signOut(),M.user=null,J(),Y(`Logout effettuato`)})}else e.innerHTML=``}function je(){let e=we();return`<div class="auth-gate"><div class="auth-card">
  ...
  <div class="card"><h3>Movimenti recenti — ${l(V(n))}</h3><div class="tx-list">${f.length===0?`<div class="empty">Nessun movimento. Premi + per iniziare.</div>`:f.map(e=>_t(e,!1)).join(``)}</div></div>`}function bt(){let e=k(),t=Ge(),n=Qe(5,0,e.year,e.month,t).map(e=>{let[n,r]=e.key.split(`-`).map(Number),i=B(F(n,r-1),t),a=i.filter(e=>e.type===`in`&&!g(e)).reduce((e,t)=>e+t.amount,0),o=i.filter(L).reduce((e,t)=>e+t.amount,0),s=i.filter(g).reduce((e,t)=>e+t.amount,0);return{key:e.key,label:e.label,income:a,expense:o,net:a-o,transfers:s}}),r=n[n.length-1]||{income:0,expense:0,net:0},i=$e(),a=tt(),o=at(6),c=I(B(de(e.bounds),t)),u=Math.max(1,...Object.values(c));return`
  ...
  </div>`}function xt(){let e=[...y.transactions];if(K&&(e=e.filter(e=>e.category===K)),q){let[t,n]=q.split(`-`).map(Number);e=e.filter(e=>fe(e.date)===q)}return e.sort((e,t)=>e.date<t.date?1:-1),e}function St(){let e=new Set;return y.transactions.forEach(t=>e.add(fe(t.date))),e.add(`${W}-${String(U+1).padStart(2,`0`)}`),[...e].sort().reverse()}function Ct(){let e=xt(),t=G.size,n=St();return`
  <div class="topbar">
    <h1>Movimenti</h1>
  ...
  </div>`}function wt(){let e=k(),t=I(de(e.bounds));return`
  ...
  </div>`}function Ot(){return M.user,`<span class="cloud-dot ${De()}"></span><span>${l(Ee())}</span>`}function kt(){return`<div class="sync-grid">
    <div class="sync-pill">Stato<b>${M.syncing?`In corso`:M.pending?`Da sincronizzare`:M.lastError?`Errore`:M.user?`Sincronizzato`:`Locale`}</b></div>
    <div class="sync-pill">Ultimo sync<b>${h(M.lastSync)}</b></div>
    <div class="sync-pill">Ultima modifica<b>${h(Ce())}</b></div>
  </div>
  ${M.lastError?`<div class="alert-banner danger"><div class="aicon">⚠️</div><div class="abody"><div class="atitle">Errore sincronizzazione</div><div class="adesc">${l(M.lastError)}</div></div></div>`:``}`}function At(){let e=!!M.user;return`
  <div class="topbar"><h1>Utenti / Cloud</h1></div>
  <div class="cloud-status" id="cloudLiveStatus">${Ot()}</div>
  <div class="grid row2" style="margin-bottom:16px;">
    <div class="card">
      <h3>Accesso utente</h3>
      ${Te()?``:`<div class="empty" style="text-align:left;padding-top:0">Configura Supabase qui sotto, poi potrai creare utenti e salvare i dati separatamente per ciascun account.</div>`}
      ${e?`
        <div class="empty" style="text-align:left;padding-top:0">Sei collegato come <b>${l(M.user.email||M.user.id)}</b>. Ogni modifica viene salvata nel cloud del tuo utente e mantenuta anche in cache locale sul dispositivo.</div>
...
grant execute on function public.get_libretto_state() to authenticated;`)}</div>
  ...
  </div>`}function J(){let e=document.getElementById(`main`);Ae(),ht();let t=document.getElementById(`fabAdd`);t&&(t.style.display=ke()?`none`:`flex`);try{if(!mt()&&pt.includes(H)&&(H=`dashboard`),ke()&&H!==`cloud`&&H!==`help`){e.innerHTML=je(),Me();return}H===`dashboard`?e.innerHTML=yt():H===`transactions`?e.innerHTML=Ct():H===`budget`?e.innerHTML=wt():H===`analytics`?e.innerHTML=bt():H===`goals`?e.innerHTML=Tt():H===`accounts`?e.innerHTML=Et():H===`categories`?e.innerHTML=Dt():H===`cloud`?e.innerHTML=At():H===`help`?e.innerHTML=jt():H===`feedback`&&(e.innerHTML=Mt()),Ut()}catch(t){console.error(`Errore rendering Libretto`,t),e.innerHTML=`<div class="topbar"><h1>Ops, qualcosa non torna</h1></div><div class="card"><h3>Errore temporaneo</h3><div class="empty" style="text-align:left">Ho intercettato un problema nel rendering della pagina. Prova a esportare un backup dalla sezione Conti/Backup se disponibile, oppure ricarica la pagina. Dettaglio tecnico: ${l(t.message||String(t))}</div></div>`}}var Nt=[`date`,`type`,`amount`,`payee`,`account`,`category`,`movementType`,`transferTo`,`goal`,`recurring`,`recurringFreq`,`recurringNextDate`];function Pt(e){let t=String(e??``);return/[";,\n\r]/.test(t)?`"`+t.replace(/"/g,`""`)+`"`:t}function Ft(){let e=[Nt,[a(),`out`,`12.50`,`Esselunga`,`Conto corrente`,`Spesa`,`standard`,``,``,`no`,``,``],[a(),`in`,`1850.00`,`Stipendio`,`Conto corrente`,`Stipendio`,`standard`,``,``,`no`,``,``],[a(),`out`,`300.00`,`Giroconto risparmio`,`Conto corrente`,`Risparmi`,`transfer`,`Conto Arancio`,`Risparmi liquidi`,`no`,``,``],[a(),`out`,`9.99`,`Spotify`,`Conto corrente`,`Abbonamenti`,`standard`,``,``,`yes`,`Mensile`,o(a(),30)]].map(e=>e.map(Pt).join(`;`)).join(`
`),t=new Blob([e],{type:`text/csv;charset=utf-8`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`libretto-template-movimenti.csv`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n),Y(`Template CSV scaricato`)}function It(e){e=String(e||``).replace(/^\ufeff/,``);let t=e.split(/\r?\n/).find(e=>e.trim())||``,n=[`;`,`,`,`	`],r=`;`,i=-1;for(let e of n){let n=(t.match(new RegExp(e===`	`?`\\t`:e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),`g`))||[]).length;n>i&&(i=n,r=e)}let a=[],o=[],s=``,c=!1;for(let t=0;t<e.length;t++){let n=e[t],i=e[t+1];n===`"`?c&&i===`"`?(s+=`"`,t++):c=!c:n===r&&!c?(o.push(s),s=``):(n===`
`||n===`\r`)&&!c?(n===`\r`&&i===`
`&&t++,o.push(s),o.some(e=>String(e).trim()!==``)&&a.push(o),o=[],s=``):s+=n}if(o.push(s),o.some(e=>String(e).trim()!==``)&&a.push(o),!a.length)return[];let l=a[0].map(e=>String(e||``).trim());return a.slice(1).map((e,t)=>{let n={_row:t+2};return l.forEach((t,r)=>n[t]=String(e[r]||``).trim()),n})}function Lt(e){if(!e)return``;let t=String(e).trim().toLowerCase(),n=y.accounts.find(e=>String(e.id).toLowerCase()===t);if(n)return n.id;let r=y.accounts.find(e=>String(e.name||``).trim().toLowerCase()===t);return r?r.id:``}function Rt(e){if(!e)return null;let t=String(e).trim().toLowerCase(),n=y.goals.find(e=>String(e.id).toLowerCase()===t);if(n)return n.id;let r=y.goals.find(e=>String(e.name||``).trim().toLowerCase()===t);return r?r.id:null}function zt(e){return[`si`,`sì`,`yes`,`true`,`1`,`y`].includes(String(e||``).trim().toLowerCase())}function Bt(e){let t=[],n=(e.date||e.data||``).slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(n)||t.push(`data non valida: usa YYYY-MM-DD`);let r=String(e.type||e.tipo||`out`).toLowerCase();[`in`,`out`].includes(r)||t.push(`type deve essere in oppure out`);let a=parseFloat(String(e.amount||e.importo||``).replace(`,`,`.`));(!a||a<=0)&&t.push(`importo non valido`);let o=Lt(e.account||e.conto||e.accountId);o||t.push(`conto origine non trovato`);let s=e.category||e.categoria||`Altro`,c=y.categories.find(e=>String(e.name).toLowerCase()===String(s).toLowerCase());c?s=c.name:t.push(`categoria non trovata`);let l=String(e.movementType||e.tipoMovimento||`standard`).toLowerCase()===`transfer`?`transfer`:`standard`,u=l===`transfer`?Lt(e.transferTo||e.contoDestinazione||e.toAccount):null;l===`transfer`&&!u&&t.push(`conto destinazione non trovato`),l===`transfer`&&u===o&&t.push(`origine e destinazione devono essere diversi`);let d=zt(e.recurring||e.ricorrente),f=e.recurringFreq||e.frequenza||`Mensile`,p=(e.recurringNextDate||e.prossimaData||``).slice(0,10)||null;return{tx:{id:i(),date:n,account:o,category:s,payee:e.payee||e.descrizione||e.esercente||(l===`transfer`?`Trasferimento`:r===`in`?`Entrata`:`Spesa`),amount:a,type:r,movementType:l,transferTo:u,goalId:Rt(e.goal||e.obiettivo),recurring:d&&l!==`transfer`,recurringFreq:d?f:null,recurringNextDate:d?p:null},errors:t,row:e._row}}function Vt(e){let t=It(e).map(Bt),n=t.filter(e=>!e.errors.length),r=t.filter(e=>e.errors.length);document.getElementById(`modalRoot`).innerHTML=`
  <div class="modal-bg" id="bulkBg"><div class="modal" style="max-width:860px;">
    ...
    <div class="empty" style="text-align:left;padding:0 0 10px;">Formato accettato: CSV da Excel con colonne <span class="num">${Nt.join(`, `)}</span>. Le colonne principali sono: date, type, amount, payee, account, category.</div>
  ...
  </div></div>`,document.getElementById(`bulkBg`).addEventListener(`click`,e=>{e.target.id===`bulkBg`&&X()}),document.getElementById(`bulkClose`).addEventListener(`click`,X),document.getElementById(`bulkCancel`).addEventListener(`click`,X),document.getElementById(`bulkImportOk`).addEventListener(`click`,()=>{y.transactions.push(...n.map(e=>e.tx)),y.transactions.sort((e,t)=>e.date<t.date?1:-1),N(),X(),J(),Y(`${n.length} movimenti importati`)})}function Ht(e){if(!e)return;let t=new FileReader;t.onload=()=>Vt(t.result),t.readAsText(e)}function Ut(){let e=document.getElementById(`prevMonth`),t=document.getElementById(`nextMonth`);e&&e.addEventListener(`click`,()=>{let e=pe(!0),t=`${W}-${String(U+1).padStart(2,`0`)}`,n=e.indexOf(t),[r,i]=(n>0?e[n-1]:_(v(new Date(W,U,1),-1))).split(`-`).map(Number);W=r,U=i-1,J()}),t&&t.addEventListener(`click`,()=>{let e=pe(!0),t=`${W}-${String(U+1).padStart(2,`0`)}`,n=e.indexOf(t),[r,i]=(n>=0&&n<e.length-1?e[n+1]:_(v(new Date(W,U,1),1))).split(`-`).map(Number);W=r,U=i-1,J()}),document.querySelectorAll(`[data-dismiss]`).forEach(e=>e.addEventListener(`click`,()=>ut(e.dataset.dismiss))),document.querySelectorAll(`[data-stop-rec]`).forEach(e=>e.addEventListener(`click`,()=>ne(e.dataset.stopRec,e.dataset.stopRecCat)));let n=document.getElementById(`fbSendBtn`);n&&n.addEventListener(`click`,()=>{let e=document.getElementById(`fbType`)?.value||`altro`,t=(document.getElementById(`fbTitle`)?.value||``).trim(),n=(document.getElementById(`fbBody`)?.value||``).trim(),r=(document.getElementById(`fbExpected`)?.value||``).trim();if(!t){Y(`Inserisci almeno un titolo`);return}let i={bug:`Segnalazione bug`,feature:`Nuova funzionalità`,miglioramento:`Miglioramento esistente`,altro:`Altro`}[e]||e,a=M.user?.email||`utente non loggato`,o=A,s=encodeURIComponent(`[Libretto Feedback] ${i}: ${t}`),c=encodeURIComponent(`--- FEEDBACK LIBRETTO ---
Tipo: ${i}
Titolo: ${t}
Utente: ${a}
Versione app: ${o}
...
Tipo richiesta: ${i}
Titolo: ${t}
Dettaglio: ${n||`(vedi sopra)`}${r?`\nComportamento atteso: ${r}`:``}
Chiedi a Claude Code di: valutare la fattibilità, suggerire l'approccio migliore e implementare la modifica nel rispetto dell'architettura esistente.`);window.location.href=`mailto:manciaracina92@gmail.com?subject=${s}&body=${c}`});let r=document.getElementById(`dashboardAccountSelect`);r&&r.addEventListener(`change`,()=>{y.settings.dashboardAccountId=r.value,N(),J()});let i=document.getElementById(`toggleDashboardBalances`);if(i&&i.addEventListener(`click`,()=>{y.settings.dashboardShowBalances=!Ke(),N(),J()}),document.getElementById(`dashboardTrend`)){let e=k(),t=Ge();ot(`dashboardTrend`,Qe(5,0,e.year,e.month,t).map(e=>{let[n,r]=e.key.split(`-`).map(Number),i=B(F(n,r-1),t),a=i.filter(e=>e.type===`in`&&!g(e)).reduce((e,t)=>e+t.amount,0),o=i.filter(L).reduce((e,t)=>e+t.amount,0);return Object.assign({},e,{income:a,expense:o,net:a-o})}))}if(document.getElementById(`analyticsTrend`)){let e=k(),t=Ge();ot(`analyticsTrend`,Qe(5,0,e.year,e.month,t).map(e=>{let[n,r]=e.key.split(`-`).map(Number),i=B(F(n,r-1),t),a=i.filter(e=>e.type===`in`&&!g(e)).reduce((e,t)=>e+t.amount,0),o=i.filter(L).reduce((e,t)=>e+t.amount,0);return Object.assign({},e,{income:a,expense:o,net:a-o})}))}document.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>{let t=e.dataset.del;Gt([t]),J(),Y(`Movimento eliminato`)})),document.querySelectorAll(`[data-edittx]`).forEach(e=>e.addEventListener(`click`,()=>Jt(e.dataset.edittx))),document.querySelectorAll(`[data-budget]`).forEach(e=>e.addEventListener(`change`,()=>{y.budgets[e.dataset.budget]=parseFloat(e.value)||0,N(),J()}));let a=document.getElementById(`saveCloudConfigBtn`);a&&a.addEventListener(`click`,async()=>{let e=(document.getElementById(`supabaseUrl`).value||``).trim();e=e.replace(/\/rest\/v1\/?$/,``).replace(/\/auth\/v1\/?$/,``).replace(/\/$/,``);let t=(document.getElementById(`supabaseAnon`).value||``).trim();if(!e||!t){Y(`Inserisci URL e anon key Supabase`);return}localStorage.setItem(_e,JSON.stringify({url:e,anonKey:t})),await Ne(),J(),Y(`Cloud configurato`)});let o=document.getElementById(`clearCloudConfigBtn`);o&&o.addEventListener(`click`,async()=>{if(M.client)try{await M.client.auth.signOut()}catch{}localStorage.removeItem(_e),M={client:null,user:null,ready:!1,loading:!1},J(),Y(`Configurazione cloud rimossa`)});let s=document.getElementById(`cloudLoginBtn`);s&&s.addEventListener(`click`,async()=>Wt(`login`));let c=document.getElementById(`cloudSignupBtn`);c&&c.addEventListener(`click`,async()=>Wt(`signup`));let u=document.getElementById(`cloudLogoutBtn`);u&&u.addEventListener(`click`,async()=>{M.client&&await M.client.auth.signOut(),M.user=null,J(),Y(`Logout effettuato`)});let d=document.getElementById(`cloudSyncBtn`);d&&d.addEventListener(`click`,async()=>{let e=await Fe();J(),Y(e?`Sincronizzazione completata`:`Sincronizzazione non riuscita`)});let f=document.getElementById(`cloudPullBtn`);f&&f.addEventListener(`click`,async()=>{let e=await Pe({force:!0});J(),Y(e?`Dati scaricati dal cloud`:`Download cloud non riuscito`)});let p=document.getElementById(`cloudPushBtn`);p&&p.addEventListener(`click`,async()=>{let e=await Be();J(),Y(e?`Dati salvati nel cloud`:`Salvataggio cloud non riuscito`)});let m=document.getElementById(`cloudHardReloadBtn`);m&&m.addEventListener(`click`,()=>{location.href=location.pathname+`?v=22&refresh=`+Date.now()});let h=document.getElementById(`copySqlBtn`);h&&h.addEventListener(`click`,()=>{let e=document.querySelector(`.code-block`)?.textContent||``;navigator.clipboard.writeText(e).then(()=>Y(`SQL copiato`))});let ee=document.getElementById(`openChatGPTBtn`);ee&&ee.addEventListener(`click`,()=>tn(`https://chatgpt.com/`,`ChatGPT`));let b=document.getElementById(`openClaudeBtn`);b&&b.addEventListener(`click`,()=>tn(`https://claude.ai/new`,`Claude`));let x=document.getElementById(`copyUpdatePromptBtn`);x&&x.addEventListener(`click`,rn);let S=document.getElementById(`exportHtmlBtn`);S&&S.addEventListener(`click`,nn);let te=document.getElementById(`filterCat`),C=document.getElementById(`filterMonth`);te&&te.addEventListener(`change`,()=>{K=te.value,G=new Set,J()}),C&&C.addEventListener(`change`,()=>{q=C.value,G=new Set,J()});let w=document.getElementById(`selectAllBtn`);w&&w.addEventListener(`click`,()=>{let e=xt();G.size===e.length?G=new Set:e.forEach(e=>G.add(e.id)),J()}),document.querySelectorAll(`[data-chk]`).forEach(e=>e.addEventListener(`change`,()=>{e.checked?G.add(e.dataset.chk):G.delete(e.dataset.chk),J()}));let re=document.getElementById(`delSelBtn`);re&&re.addEventListener(`click`,()=>{let e=[...G];Z(`Eliminare ${e.length} moviment${e.length===1?`o`:`i`}?`,`L'operazione non è reversibile.`,()=>{Gt(e),G=new Set,J(),Y(`${e.length} moviment${e.length===1?`o`:`i`} eliminat${e.length===1?`o`:`i`}`)})});let ie=document.getElementById(`delAllBtn`);ie&&ie.addEventListener(`click`,()=>{let e=xt();if(!e.length){Y(`Nessun movimento da eliminare`);return}Z(`Eliminare ${K||q?`i movimenti filtrati`:`tutti i movimenti`}?`,`Verranno rimossi ${e.length} movimenti. L'operazione non è reversibile.`,()=>{Gt(e.map(e=>e.id)),G=new Set,J(),Y(`${e.length} movimenti eliminati`)})});let T=document.getElementById(`downloadTxTemplateBtn`);T&&T.addEventListener(`click`,Ft);let E=document.getElementById(`bulkImportTxBtn`),D=document.getElementById(`bulkImportTxFile`);E&&D&&E.addEventListener(`click`,()=>D.click()),D&&D.addEventListener(`change`,()=>{Ht(D.files[0]),D.value=``});let ae=document.getElementById(`addCatBtn`);ae&&ae.addEventListener(`click`,()=>Yt(null)),document.querySelectorAll(`[data-editcat]`).forEach(e=>e.addEventListener(`click`,()=>Yt(parseInt(e.dataset.editcat)))),document.querySelectorAll(`[data-delcat]`).forEach(e=>e.addEventListener(`click`,()=>{let t=parseInt(e.dataset.delcat),n=y.categories[t];y.transactions.some(e=>e.category===n.name)?Z(`Eliminare "${n.name}"?`,`Questa categoria è usata da alcuni movimenti. I movimenti esistenti conserveranno il nome della categoria ma non sarà più gestibile.`,()=>{y.categories.splice(t,1),N(),J(),Y(`Categoria eliminata`)}):(y.categories.splice(t,1),N(),J(),Y(`Categoria eliminata`))}));let oe=document.getElementById(`addGoalBtn`);oe&&oe.addEventListener(`click`,()=>Xt(null)),document.querySelectorAll(`[data-editgoal]`).forEach(e=>e.addEventListener(`click`,()=>Xt(e.dataset.editgoal))),document.querySelectorAll(`[data-delgoal]`).forEach(e=>e.addEventListener(`click`,()=>{let t=y.goals.find(t=>t.id===e.dataset.delgoal);t&&Z(`Eliminare obiettivo "${l(t.name)}"?`,`I movimenti già registrati resteranno invariati.`,()=>{y.goals=y.goals.filter(e=>e.id!==t.id),N(),J(),Y(`Obiettivo eliminato`)})}));let se=document.getElementById(`addAcctBtn`);se&&se.addEventListener(`click`,()=>Zt(null)),document.querySelectorAll(`[data-editacct]`).forEach(e=>e.addEventListener(`click`,()=>Zt(e.dataset.editacct)))}async function Wt(e){if(!M.client){Y(`Prima salva la configurazione Supabase`);return}let t=(document.getElementById(`cloudEmail`)?.value||``).trim(),n=(document.getElementById(`cloudPassword`)?.value||``).trim();if(!t||!n){Y(`Inserisci email e password`);return}try{let r=e===`signup`?await M.client.auth.signUp({email:t,password:n,options:{emailRedirectTo:`https://fandore.github.io/Libretto/`}}):await M.client.auth.signInWithPassword({email:t,password:n});if(r.error)throw r.error;r.data&&r.data.session&&r.data.session.user?M.user=r.data.session.user:r.data&&r.data.user&&(M.user=r.data.user);let i=await M.client.auth.getUser();i&&i.data&&i.data.user&&(M.user=i.data.user),await Ie(),await Fe(),H=`dashboard`,J(),Y(e===`signup`?`Account creato. Controlla eventuale email di conferma.`:`Accesso effettuato`)}catch(e){console.warn(e),Y(e.message||`Accesso non riuscito`)}}function Gt(e){y.transactions=y.transactions.filter(t=>!e.includes(t.id)),N()}function Y(e){let t=document.getElementById(`toastRoot`),n=document.createElement(`div`);n.className=`toast`,n.textContent=e,t.innerHTML=``,t.appendChild(n),setTimeout(()=>n.remove(),2400)}function X(){document.getElementById(`modalRoot`).innerHTML=``}function Z(e,t,n){document.getElementById(`modalRoot`).innerHTML=`
  ...
  </div>`,document.getElementById(`confBg`).addEventListener(`click`,e=>{e.target.id===`confBg`&&X()}),document.getElementById(`confClose`).addEventListener(`click`,X),document.getElementById(`confCancel`).addEventListener(`click`,X),document.getElementById(`confOk`).addEventListener(`click`,()=>{X(),n()})}var Q=`out`,Kt=S()[0];function qt(){Jt(null)}function Jt(e=null){let t=e?y.transactions.find(t=>t.id===e):null;Q=t?t.type:`out`,Kt=t?t.category:S()[0];let n=!!(t&&t.recurring),r=!!(t&&g(t)),s=t?`Modifica movimento`:`Nuovo movimento`;document.getElementById(`modalRoot`).innerHTML=`
  <div class="modal-bg" id="modalBg">
    <div class="modal">
      ...
      <div class="field"><label>Categoria</label>
        <div class="cat-pick" id="catPick">${S().map(e=>`<div class="cat-chip ${e===Kt?`active`:``}" data-cat="${e}">${b(e)} ${e}</div>`).join(``)}</div>
      </div>
...
Analizza prima il codice e poi restituisci un file HTML completo aggiornato.`;return e?`${t}\n\n--- CODICE HTML CORRENTE ---\n${Qt()}`:t}async function en(e){try{return await navigator.clipboard.writeText(e),!0}catch{let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.left=`-9999px`,t.style.top=`-9999px`,document.body.appendChild(t),t.focus(),t.select();let n=!1;try{n=document.execCommand(`copy`)}catch{}return t.remove(),n}}async function tn(e,t){Y(await en($t(!0))?`Prompt + HTML copiati. Incollali in ${t}.`:`Apri ${t} e allega/esporta il file HTML.`),window.open(e,`_blank`,`noopener,noreferrer`)}function nn(){let e=new Blob([Qt()],{type:`text/html`}),t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`libretto-current-${a()}.html`,document.body.appendChild(n),n.click(),n.remove(),URL.revokeObjectURL(t),Y(`HTML corrente esportato`)}function rn(){let e=$t(!1);document.getElementById(`modalRoot`).innerHTML=`
